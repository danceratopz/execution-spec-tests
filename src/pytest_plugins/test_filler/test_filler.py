...
def pytest_addoption(parser):
    ...
    test_group = parser.getgroup("fillers", "Arguments defining filler location and output")
...
def state_test(request, t8n, b11r, fork, engine, reference_spec, eips, fixture_collector) -> StateTestFiller:
    """
...
@pytest.fixture(scope="function")
def blockchain_test(request, t8n, b11r, fork, engine, reference_spec, eips, fixture_collector) -> BlockchainTestFiller:
    """
...
def pytest_runtest_call(item):
    ...
    if "state_test" in item.fixturenames and "blockchain_test" in item.fixturenames:
        raise InvalidFiller("A filler should only implement either a state test or " "a blockchain test; not both.")
