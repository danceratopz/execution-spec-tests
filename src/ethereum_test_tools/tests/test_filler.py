...
def test_make_genesis(fork: Fork, hash: str):
    ...
    _, genesis = StateTest(env=env, pre=pre, post={}, txs=[], tag="some_state_test").make_genesis(b11r, t8n, fork)
...
def test_fill_state_test(fork: Fork, expected_json_file: str):
    ...
    post = {
        "0x1000000000000000000000000000000000000000": Account(code="0x4660015500", storage={"0x01": "0x01"}),
    }
...
def test_fill_london_blockchain_test_valid_txs():
    ...
    pre = {
        ...
        "0xd02d72E067e77158444ef2020Ff2d325f929B363": Account(balance=0x1000000000000000000, nonce=1),
